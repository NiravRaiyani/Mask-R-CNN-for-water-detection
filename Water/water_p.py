"""
Mask R-CNN
Train the Mask R-CNN model to detect water.

Based on Tensorflow and Keras implementation of Mask R-CNN by Matterport Inc.
...
class WaterConfig(Config):
    ...
    NUM_CLASSES = 1 + 3  # Background + Water + Person + side_walk
...
class WaterDataset(utils.Dataset):
    ...
    def load_water(self, dataset_dir, subset):
        ...
        """
        # Add classes. Adding 'Water and 'Person' as classes
        self.add_class("water", 1, "water")
        self.add_class("water", 2, "person")
        self.add_class("water", 3, "side_walk")
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "via_region_water_data.json")))
